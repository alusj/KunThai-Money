...
export default function ServicesContainer({ setActiveService }) {
  ...
  const services = [
    ...
    { key: "restaurant", title: t("Restaurant"), icon: <FaUtensils size={22} /> },
    { key: "supermarket", title: t("Supermarket"), icon: <FaShoppingCart size={22} /> },
    { key: "pharmacy", title: t("Pharmacy"), icon: <FaCapsules size={22} /> },
    { key: "events", title: t("Events"), icon: <IoTicketOutline size={22} /> },
    { key: "insurance", title: t("Insurance"), icon: <FaShieldAlt size={22} /> },
    { key: "donation", title: t("Donations"), icon: <GiReceiveMoney size={22} /> },
    { key: "electricity", title: t("Electricity"), icon: <MdElectricBolt size={22} /> },
    { key: "internet", title: t("Internet"), icon: <MdWifi size={22} /> },
    { key: "tv", title: t("TV Subscribe"), icon: <MdTv size={22} /> },
    { key: "government", title: t("Gov Services"), icon: <RiGovernmentLine size={22} /> },
    { key: "investment", title: t("Investments"), icon: <HiOutlineTrendingUp size={22} /> },
    { key: "qr", title: t("QR Pay"), icon: <BsQrCodeScan size={22} /> },
  ];
